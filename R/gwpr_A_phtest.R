#' Locally Hausman Test Based on Adaptive Distance Bandwidth
#'
#' @description This function perform Hausman test in each regression based on different subsamples divided by the adaptive distance bandwidth.
#'
...
#' }
#' @noRd
gwpr_A_phtest <- function(bw = bw, data, index, SDF, ID_list, random.method = random.method,
