#' Locally F Test Based on Fixed Distance Bandwidth
#'
#' @description This function perform F test in each regression based on different subsamples divided by the fixed distance bandwidth.
#'
...
#' }
#' @noRd
gwpr_F_pFtest <- function(bw = bw, data, SDF, index, ID_list,
